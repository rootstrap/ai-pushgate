...
// src/generated/pushgate-config-v2-validator.ts
...
var schema13 = { "type": "object", "additionalProperties": false, "required": ["name", "command"], "properties": { "name": { "type": "string", "minLength": 1 }, "command": { "description": "Argv tokens for deterministic command execution.", "type": "array", "minItems": 1, "items": { "type": "string", "minLength": 1 } }, "extensions": { "type": "array", "items": { "type": "string", "minLength": 1 } }, "timeout_seconds": { "description": "Maximum runtime before the deterministic command is treated as timed out.", "type": "integer", "minimum": 1, "default": 60 }, "mode": { "description": "Whether command failures block the push or only warn locally.", "type": "string", "enum": ["blocking", "warning"], "default": "blocking" }, "run": { "description": "Whether the command requires matching live changed files or always runs.", "type": "string", "enum": ["changed_files", "always"], "default": "changed_files" }, "fail_fast": { "description": "Whether a blocking failure stops later deterministic command checks.", "type": "boolean", "default": true } } };
var func2 = ucs2length;
var schema16 = { "description": "Whether a built-in policy violation blocks the push or only warns locally.", "type": "string", "enum": ["blocking", "warning"], "default": "blocking" };
...
function validate11(data, { instancePath = "", parentData, parentDataProperty, rootData = data } = {}) {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.forbidden_paths !== void 0) {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.review !== void 0) {
      ...
      if (data1 && typeof data1 == "object" && !Array.isArray(data1)) {
        ...
        if (data1.max_lines_for_full_file !== void 0) {
      ...
      if (Array.isArray(data5)) {
        ...
        for (let i0 = 0; i0 < len0; i0++) {
          ...
          if (data6 && typeof data6 == "object" && !Array.isArray(data6)) {
            ...
            if (data6.timeout_seconds !== void 0) {
...
function validatePushgateConfig(value) {
...
// src/generated/ai-review-output-v1-validator.ts
...
var validateSchema2 = validate102;
function normalizeErrors2(errors) {
  return (errors ?? []).map((error) => ({
    instancePath: error.instancePath ?? "",
    schemaPath: error.schemaPath ?? "",
    keyword: error.keyword ?? "",
...
function validateAiReviewOutput(value) {
  const valid = validateSchema2(value);
  if (valid) {
    return { valid: true };
  }
  return {
    valid: false,
    errors: normalizeErrors2(validateSchema2.errors)
  };
}
